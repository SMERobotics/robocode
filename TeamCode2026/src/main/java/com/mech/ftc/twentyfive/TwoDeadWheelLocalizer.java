...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -7379.954259007631; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -8569.529308303721; // x position of the perpendicular encoder (in tick units)
    }
