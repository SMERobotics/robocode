...
public class DeviceIMU extends Device {
    ...
    private final Rev9AxisImuOrientationOnRobot revOrientationOnRobot = new Rev9AxisImuOrientationOnRobot(Rev9AxisImuOrientationOnRobot.LogoFacingDirection.DOWN, Rev9AxisImuOrientationOnRobot.I2cPortFacingDirection.LEFT);

    public static double headingOffset;
    public static double yaw;
    public static double hubYaw;
...
//        DeviceIMU.setSnapshotYaw();
    ...
    public void update() {
        ...
        hubYaw = imu.getRobotYawPitchRollAngles().getYaw(AngleUnit.DEGREES) + headingOffset;
