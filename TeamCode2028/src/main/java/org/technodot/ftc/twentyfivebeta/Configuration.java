...
public class Configuration {
    ...
    public static volatile double INTAKE_LEFT_ACTIVATION = 0.0;
    public static volatile double INTAKE_RIGHT_ACTIVATION = 0.0;
    public static volatile double INTAKE_LEFT_DEACTIVATION = 0.0;
    public static volatile double INTAKE_RIGHT_DEACTIVATION = 0.0;
